...
def crossing_number() -> None:
    folder_path = r"dataset_2_skeleton_Zhang_Suen/.Asian-African panel_CIAT/Asian-African panel_New"
    ...
    for file_name in file_names:
        ...
        # save_path = rf"clustered_skeleton/Crossing-number/gradient-based-optimization/RUC-Net/{file_name}"
        save_path = rf"dataset_2_clustered_Zhang_Suen/.Asian-African panel_CIAT/Asian-African panel_New/crossing_number/{file_name}"
        ...
        # f1_save_path = rf"y_pred/crossing-number/gradient-based-optimization/RUC-Net/{file_name}"
        f1_save_path = rf"dataset_2_y_pred/.Asian-African panel_CIAT/Asian-African panel_New/crossing_number/Zhang-Suen/{file_name}"
        cv2.imwrite(f1_save_path, img_f1)
        print(f"Successfully generated f1 image: {file_name}")
        
        # Toggle break (on in first run, off for continuous results)
        break
