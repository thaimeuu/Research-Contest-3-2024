...
def crossing_number() -> None:
    folder_path = r"dataset_1_skeleton_gradient_based_optimization/RUC-Net"
    ...
    for file_name in file_names:
        ...
        f1_save_path = rf"dataset_1_y_pred/crossing-number/gradient-based-optimization/RUC-Net/{file_name}"
